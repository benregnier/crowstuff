...
- live is a live code sequencer modifiable thru druid, based upon [this script uploaded to lines](https://llllllll.co/t/crow-druid-scripts/25974/21?u=q_ben). Per that post's instructions here are some sample actions:
